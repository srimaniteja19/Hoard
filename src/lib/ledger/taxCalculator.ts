...
export const US_STATES = [
  { code: "AL", name: "Alabama", flatRate: 0.05 },
  { code: "AK", name: "Alaska (0% Tax)", flatRate: 0.0 },
  { code: "AZ", name: "Arizona", flatRate: 0.025 },
  { code: "AR", name: "Arkansas", flatRate: 0.044 },
  { code: "CA", name: "California (Progressive 1%–13.3%)", isProgressive: true },
  { code: "CO", name: "Colorado (Flat 4.4%)", flatRate: 0.044 },
  { code: "CT", name: "Connecticut", flatRate: 0.06 },
  { code: "DE", name: "Delaware", flatRate: 0.055 },
  { code: "FL", name: "Florida (0% Tax)", flatRate: 0.0 },
  { code: "GA", name: "Georgia", flatRate: 0.0549 },
  { code: "HI", name: "Hawaii", flatRate: 0.07 },
  { code: "ID", name: "Idaho", flatRate: 0.058 },
  { code: "IL", name: "Illinois (Flat 4.95%)", flatRate: 0.0495 },
  { code: "IN", name: "Indiana (Flat 3.05%)", flatRate: 0.0305 },
  { code: "IA", name: "Iowa", flatRate: 0.038 },
  { code: "KS", name: "Kansas", flatRate: 0.057 },
  { code: "KY", name: "Kentucky (Flat 4.0%)", flatRate: 0.04 },
  { code: "LA", name: "Louisiana", flatRate: 0.0425 },
  { code: "ME", name: "Maine", flatRate: 0.065 },
  { code: "MD", name: "Maryland", flatRate: 0.05 },
  { code: "MA", name: "Massachusetts (Flat 5.0%)", flatRate: 0.05 },
  { code: "MI", name: "Michigan (Flat 4.25%)", flatRate: 0.0425 },
  { code: "MN", name: "Minnesota", flatRate: 0.075 },
  { code: "MS", name: "Mississippi", flatRate: 0.047 },
  { code: "MO", name: "Missouri", flatRate: 0.048 },
  { code: "MT", name: "Montana", flatRate: 0.059 },
  { code: "NE", name: "Nebraska", flatRate: 0.058 },
  { code: "NV", name: "Nevada (0% Tax)", flatRate: 0.0 },
  { code: "NH", name: "New Hampshire (0% Earned)", flatRate: 0.0 },
  { code: "NJ", name: "New Jersey", flatRate: 0.065 },
  { code: "NM", name: "New Mexico", flatRate: 0.049 },
  { code: "NY", name: "New York (Progressive 4%–10.9%)", isProgressive: true },
  { code: "NC", name: "North Carolina (Flat 4.5%)", flatRate: 0.045 },
  { code: "ND", name: "North Dakota", flatRate: 0.02 },
  { code: "OH", name: "Ohio", flatRate: 0.035 },
  { code: "OK", name: "Oklahoma", flatRate: 0.0475 },
  { code: "OR", name: "Oregon", flatRate: 0.0875 },
  { code: "PA", name: "Pennsylvania (Flat 3.07%)", flatRate: 0.0307 },
  { code: "RI", name: "Rhode Island", flatRate: 0.05 },
  { code: "SC", name: "South Carolina", flatRate: 0.064 },
  { code: "SD", name: "South Dakota (0% Tax)", flatRate: 0.0 },
  { code: "TN", name: "Tennessee (0% Tax)", flatRate: 0.0 },
  { code: "TX", name: "Texas (0% Tax)", flatRate: 0.0 },
  { code: "UT", name: "Utah (Flat 4.65%)", flatRate: 0.0465 },
  { code: "VT", name: "Vermont", flatRate: 0.065 },
  { code: "VA", name: "Virginia", flatRate: 0.0575 },
  { code: "WA", name: "Washington (0% Income Tax)", flatRate: 0.0 },
  { code: "WV", name: "West Virginia", flatRate: 0.0512 },
  { code: "WI", name: "Wisconsin", flatRate: 0.053 },
  { code: "WY", name: "Wyoming (0% Tax)", flatRate: 0.0 },
] as const;

export const SUPPORTED_COUNTRIES = [
  { code: "US", name: "United States (Federal + State + FICA)" },
  { code: "UK", name: "United Kingdom (PAYE + National Insurance)" },
  { code: "CA", name: "Canada (Federal + Provincial)" },
  { code: "IN", name: "India (New Tax Regime Slabs)" },
  { code: "OTHER", name: "Other / Custom Effective Rate" },
] as const;

export const CANADIAN_PROVINCES = [
  { code: "ON", name: "Ontario", rate: 0.09 },
  { code: "BC", name: "British Columbia", rate: 0.085 },
  { code: "AB", name: "Alberta (Flat 10%)", rate: 0.10 },
  { code: "QC", name: "Quebec", rate: 0.15 },
