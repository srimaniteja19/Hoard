...
export const THEME_TOKENS: Record<NotebookTheme, ThemeTokens> = {
  ...
  ink: {
    ...
    cardBg: "#1A1D26",
    popoverBg: "#1A1D26",
    popoverHoverBg: "#252A36",
    textPrimary: "#F0EDE4",
    textSecondary: "rgba(240, 237, 228, 0.65)",
    textMuted: "rgba(240, 237, 228, 0.4)",
    borderPrimary: "rgba(255, 255, 255, 0.18)",
    borderSubtle: "rgba(255, 255, 255, 0.1)",
    boxShadow: "3px 3px 0 rgba(0,0,0,0.7)",
    popoverShadow: "4px 4px 0 rgba(0,0,0,0.8)",
    accentColor: "#FCE94F",
    accentFg: "#0A0A0A",
    highlightYellow: "#FCE94F",
    activeRowBg: "#242A38",
    activeRowBorder: "#FCE94F",
    codeBg: "#1A1D26",
    codeBorder: "rgba(255, 255, 255, 0.2)",
    codeFg: "#F0EDE4",
    calloutGotchaBg: "#2A171B",
    calloutQuestionBg: "#2A2415",
    calloutFactBg: "#152A1D",
    calloutConnectsBg: "#13242E",
  },
  matcha: {
    id: "matcha",
    label: "MATCHA",
